...
(defsystem "gazebo_msgs-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "AddForceSensor" :depends-on ("_package_AddForceSensor"))
    (:file "_package_AddForceSensor" :depends-on ("_package"))
    ...
    (:file "AddJoint" :depends-on ("_package_AddJoint"))
    (:file "_package_AddJoint" :depends-on ("_package"))
    (:file "SetJointTrajectory" :depends-on ("_package_SetJointTrajectory"))
    (:file "_package_SetJointTrajectory" :depends-on ("_package"))
    (:file "StartTimer" :depends-on ("_package_StartTimer"))
    (:file "_package_StartTimer" :depends-on ("_package"))
    ...
    (:file "AddTorqueSensor" :depends-on ("_package_AddTorqueSensor"))
    (:file "_package_AddTorqueSensor" :depends-on ("_package"))
