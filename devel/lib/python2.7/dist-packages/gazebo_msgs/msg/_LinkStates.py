...
class LinkStates(genpy.Message):
  _md5sum = "9f3d212eca7362a72fb139ee626dafed"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,pose,twist,reference_frame
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.twist:
        ...
        _x = _v4
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      length = len(self.reference_frame)
      buff.write(_struct_I.pack(length))
      for val1 in self.reference_frame:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.reference_frame.append(val1)
      return self
